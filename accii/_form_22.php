...
<div class="head-acii"><h1 style="margin-bottom: 0;">Конкурс</h1><p></p></div>
        <div class="parent">
            <div class="detail-acc">
               ...
               <?= Html::beginForm(['accii/konkurs', 'id' => 'konkurs'], 'post', ['enctype' => 'multipart/form-data', 'novalidate' => 'novalidate']) ?>
                    ...
                    <?= Html::input('hidden', Yii::$app->request->csrfParam, Yii::$app->request->getCsrfToken()) ?>                                     
                            ...
                            <div>
                                ...
                                <?= Html::input('text', 'first_name', $space,['label' => 'Имя *', 'class' => 'form-control', 'required' => 'required', 'aria-invalid' => 'true', 'id' => 'first_name']) ?>
                            ...
                            <div>
                                ...
                                <?= Html::input('tel', 'mob_phone',  $space,['label' => 'Телефон *', 'class' => 'form-control', 'required' => 'required', 'aria-invalid' => 'true', 'id' => 'mob_phone', 'pattern' => '[0-9]{11}','placeholder' => '7(999)-999-9999']) ?>                                                                 
                            </div>
                            <div>
